...
// --------*****--------------------------------
// 1.We need to get name,email into the new array ? by using for loop
...
// ----------------*****------------------------
// 1.We need to get name,email into the new array ? by using for each

// const resArr = [];

// arr.forEach((elem) => {
//   const { name, email } = elem;
//   resArr.push({ name: name, email: email });
// });
...
// ------->> By using for loop
// 1.Traverse the whole array print the array  (using for loop)
...
// 1.Traverse the whole array print the array  (using for each)
...
// ----------**** -->
// 2.Print all the data which is having the rating > 4.5
...
// const fun = recipes.filter((element) => {
...
// -----------------------------------
// Example for understanding filter
...
// -----------------------------------
// 3.Print only name and cusine for rating > 4.5
...
// const res = recipes.filter((element) => {
//   const { name, cuisine } = element;
//   const tempArr = [name,cuisine];
//   if(element.rating > 4.5)
//     newArr.push(tempArr);
// });
...
// const recipe = recipes.filter((element) => {
//   if (element.rating > 4.5) return true;
//   else return false;
// });

// console.log(recipe);

// const resArr = recipe.map((element) => {
//   const { name, cuisine } = element;
//   return {
//     name,
//     cuisine,
...
// --->> Instead of using filter first and then map , we can use the both combined method called flatMap()

// ---->> By taking new array and using for loop
...
// ------->> By taking new aray and using for each
...
// const finalArr = newArr.map((recipe) => {
...
// ------->> By using flatmap(instead of using filter and map we can use the single method called flatmap) function
