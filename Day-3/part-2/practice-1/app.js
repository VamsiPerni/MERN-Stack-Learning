...
//     newDiv.innerHTML = "<h3>Hello</h3"; // it is not the best way to write , but it is easy , below is the best way to write

//     // newDiv.innerText = "<h3>Hello</h3"; // we will get text as it is so we need to write it like as below
