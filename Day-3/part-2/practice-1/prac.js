...
// -----------------Sample Examples-----------------
// ---------->> Created by using {innerText} tag

// const mainIdRoot = document.getElementById("root");

// const createUI = () => {
//   data.forEach((elements) => {
//     const newDiv = document.createElement("div");
//     const h3 = document.createElement("h5");
//     h3.innerText = "Hello-all";

//     newDiv.append(h3);
//     mainIdRoot.append(newDiv);
...
// ---------->> Created by using {innerHTML} tag
...
// -----------------Creating the Small UI with the above data-----------------
// ---------->> Created by using {innerText} tag
...
//     h4.innerText = elements.title;
//     newDiv.append(h4);

//     p.innerText = `${elements.completed ? "Done" : "Pending"}`;
//     newDiv.append(p);
...
const createUI = () => {
  data.forEach((elements) => {
    ...
    newDiv.innerHTML = `
            ...
            <p>${elements.completed ? "Done" : "Pending"}</p>
        `;
    mainIdRoot.append(newDiv);
  });
};
